        ...
        <><main id="content-box" className="order-first">
            <div className="banner-section section parallax-window" data-parallax="scroll" data-image-src="img/section-1-bg.jpg" id="section-1">
                <div className="container">
                    <div className="item">
                        <div className="bg-blue-transparent logo-fa"><span><i className="fas fa-2x fa-atom"></i></span> Simply Amazed</div>
                        <div className="bg-blue-transparent simple"><p>Your simplest HTML template, the most amazing page ever, yet free!</p></div>
                    </div>
                </div>
            </div>
